<template>
   <div class="clipboard-container">
      <el-card :body-style="{ padding: '20px' }">
         <el-form :model="searchForm" :inline="true">
            <el-form-item label="扫码枪编号:">
               <el-select v-model="searchForm.roleCode" placeholder="选择扫码枪编码" clearable @clear="searchForm.roleCode=''">
      ...
      <el-dialog v-model="dialogVisible" :title="`${formData.id?'编辑':'新增'}用户`" width="500px" :close-on-click-modal="false" :before-close="handleClose">
         <el-form :model="formData" :rules="formRules" size="medium"  ref="ruleFormRef" label-width="120">
            ...
            <el-form-item label="手机" prop="phone">
               <el-input v-model="formData.phone" type="text" placeholder="请输入手机号"></el-input>
            </el-form-item>
         </el-form>
         <template #footer>
