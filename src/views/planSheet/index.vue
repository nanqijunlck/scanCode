<template>
  <div class="clipboard-container">
    ...
    <el-dialog v-model="dialogVisible" title="导入计划单" width="30%" :close-on-click-modal="false"
      :before-close="handleClose">
      <el-upload class="upload-demo" :auto-upload="false" :on-success="handleUpSuccess" :limit="1"
        :on-exceed="handleExceed" name="excelFile" ref="uploadRef" drag
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button size="medium" type="primary" :loading="uploadLoading" @click="handleUploadSubmit">
            确定上传
          </el-button>
        </span>
      </template>
...
import { ElMessage,genFileId ,ElConfigProvider} from 'element-plus'
